export const balanceRegister = (billCounts, cashOwed, shares) => {
  ...
  if ((total - (500+cashOwed)) > 0) {
    Object.assign(breakDown, {remainder: total-(500+cashOwed)})
    Object.assign(breakDown, {over: true})
    return breakDown;
  } else if (total - (500+cashOwed) < 0) {
    Object.assign(breakDown, {short: true})
    Object.assign(breakDown, {shortBy: total-(500+cashOwed)})
    return breakDown;
